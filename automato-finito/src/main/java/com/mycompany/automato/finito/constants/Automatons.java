...
public final class Automatons {
    ...
    public ArrayList<AutomatonManager> initializeAutomatonConstants(){
        ...
        states.add(new TransitionState(7, B, 4));
        states.add(new TransitionState(8, AeB, 8));
        
        automatons.add(new AutomatonManager('d', "possui no máximo uma única ocorrência da cadeia baba", states, Arrays.asList(0,1,2,3,4,5,6,7)));
